...
class Anti_Tank(Unit):
	def __init__(self, level, game, territory=None, buildings=None, health=None, build=True):
		super().__init__(level, game, territory, buildings, health, build)
		self.name = "Anti Tank"
		self.description = "Anti Tank guns are defensive units for countering attacks by armored vehicles. They are cheap and fast to produce but they should avoid fights against unarmored targets. With their stealth characteristics they can ambush approaching tanks."
		self.special = "Is hidden as long as it is not fighting or uncovered by a scout unit of equal or higher level (Forest, Urban)."
		self.armor_class = "unarmored"
		if build:
			self.update_stats()
			if health:
		...
		self.terrain_effects = {'plains': {'HP': self.health, 'armor': self.armor_class, 'speed': None, 'strength': None}, 'hills': {'HP': self.health, 'armor': self.armor_class, 'speed': None, 'strength': None}, 'mountains': {'HP': self.health, 'armor': self.armor_class, 'speed': -1.5, 'strength': None}, 'forest': {'HP': self.health, 'armor': self.armor_class, 'speed': None, 'strength': 1.5}, 'urban': {'HP': self.health, 'armor': self.armor_class, 'speed': None, 'strength': 1.25}, 'sea': {'HP': 12, 'armor': 'ship', 'speed': None, 'strength': None}, 'enemy_territory': {'HP': None, 'armor': None, 'speed': -1.50, 'strength': None}}
	...
	def update_stats(self):
		match self.game.faction:
			case "Axis":
				match self.level:
					case 1:
						self.combat = {"unarmored": {"attack": 0.6, "defense": 1.2}, "light_armor": {"attack": 2.6, "defense": 5.2}, "heavy_armor": {"attack": 3.5, "defense": 7.0}, "airplane": {"attack": 0.6, "defense": 1.2}, "ship": {"attack": 0.6, "defense": 1.2}, "submarine": {"attack": 0.6, "defense": 1.2}, "buildings": {"attack": 0.5, "defense": 1.0}, "morale": 0.1}
						self.health = 17
						self.speed = 30
						self.view_range = 42
						self.attack_range = 0
						self.production_costs = {'corn': 1200, 'steel': 610, 'cash': 880, 'manpower': 830}
						self.research_costs = {'corn': 1800, 'steel': 1000, 'cash': 2650}
						self.daily_costs = {'corn': 52, 'manpower': 38, 'steel': 28, 'cash': 40}
						self.minimum_production_time = 2
						self.research_time = 0.083
						self.day_available = 1
					case 2:
						self.combat = {"unarmored": {"attack": 0.9, "defense": 1.8}, "light_armor": {"attack": 3.7, "defense": 7.4}, "heavy_armor": {"attack": 4.9, "defense": 9.8}, "airplane": {"attack": 1.2, "defense": 2.4}, "ship": {"attack": 0.9, "defense": 1.8}, "submarine": {"attack": 0.9, "defense": 1.8}, "buildings": {"attack": 0.7, "defense": 1.4}, "morale": 0.1}
						self.health = 23
						self.speed = 35
						self.view_range = 42
						self.attack_range = 0
						self.production_costs = {'corn': 1300, 'steel': 660, 'cash': 990, 'manpower': 830}
						self.research_costs = {'corn': 2150, 'steel': 1150, 'cash': 3250}
						self.daily_costs = {'corn': 58, 'manpower': 38, 'steel': 30, 'cash': 45}
						self.minimum_production_time = 3
						self.research_time = 8
						self.day_available = 3
					case 3:
						self.combat = {"unarmored": {"attack": 1.2, "defense": 2.4}, "light_armor": {"attack": 5.5, "defense": 11.0}, "heavy_armor": {"attack": 6.9, "defense": 13.8}, "airplane": {"attack": 1.7, "defense": 3.4}, "ship": {"attack": 1.2, "defense": 2.4}, "submarine": {"attack": 1.2, "defense": 2.4}, "buildings": {"attack": 0.9, "defense": 1.8}, "morale": 0.1}
						self.health = 35
						self.speed = 38
						self.view_range = 42
						self.attack_range = 0
						self.production_costs = {'corn': 1400, 'steel': 770, 'cash': 1100, 'manpower': 880}
						self.research_costs = {'corn': 2150, 'steel': 1150, 'cash': 3250}
						self.daily_costs = {'corn': 63, 'manpower': 40, 'steel': 35, 'cash': 50}
						self.minimum_production_time = 4
						self.research_time = 12
						self.day_available = 6
					case 4:
						self.combat = {"unarmored": {"attack": 1.7, "defense": 3.4}, "light_armor": {"attack": 7.5, "defense": 15.0}, "heavy_armor": {"attack": 9.2, "defense": 18.4}, "airplane": {"attack": 2.3, "defense": 4.6}, "ship": {"attack": 1.7, "defense": 3.4}, "submarine": {"attack": 1.7, "defense": 3.4}, "buildings": {"attack": 1.4, "defense": 2.8}, "morale": 0.2}
						self.health = 46
						self.speed = 41
						self.view_range = 42
						self.attack_range = 0
						self.production_costs = {'corn': 1600, 'steel': 880, 'cash': 1200, 'manpower': 880}
						self.research_costs = {'corn': 3400, 'steel': 1850, 'cash': 5400}
						self.daily_costs = {'corn': 73, 'manpower': 40, 'steel': 40, 'cash': 55}
						self.minimum_production_time = 4.5
						self.research_time = 18
						self.day_available = 10
					case 5:
						self.combat = {"unarmored": {"attack": 2.3, "defense": 4.6}, "light_armor": {"attack": 9.8, "defense": 19.6}, "heavy_armor": {"attack": 12.7, "defense": 25.4}, "airplane": {"attack": 3.5, "defense": 7.0}, "ship": {"attack": 2.3, "defense": 4.6}, "submarine": {"attack": 2.3, "defense": 4.6}, "buildings": {"attack": 2.1, "defense": 4.2}, "morale": 0.2}
						self.health = 58
						self.speed = 45
						self.view_range = 42
						self.attack_range = 0
						self.production_costs = {'corn': 1800, 'steel': 940, 'cash': 1400, 'manpower': 940}
						self.research_costs = {'corn': 4100, 'steel': 2200, 'cash': 6600}
						self.daily_costs = {'corn': 80, 'manpower': 43, 'steel': 43, 'cash': 63}
						self.minimum_production_time = 5
						self.research_time = 26
						self.day_available = 14
					case 6:
						self.combat = {"unarmored": {"attack": 3.5, "defense": 7.0}, "light_armor": {"attack": 12.9, "defense": 25.8}, "heavy_armor": {"attack": 16.7, "defense": 33.4}, "airplane": {"attack": 4.6, "defense": 9.2}, "ship": {"attack": 3.5, "defense": 7.0}, "submarine": {"attack": 3.5, "defense": 7.0}, "buildings": {"attack": 3.0, "defense": 6.0}, "morale": 0.3}
						self.health = 75
						self.speed = 48
						self.view_range = 42
						self.attack_range = 0
						self.production_costs = {'corn': 2000, 'steel': 1100, 'cash': 1500, 'manpower': 940}
						self.research_costs = {'corn': 4800, 'steel': 2600, 'cash': 7850}
						self.daily_costs = {'corn': 90, 'manpower': 43, 'steel': 48, 'cash': 70}
						self.minimum_production_time = 5.75
						self.research_time = 34
						self.day_available = 18
			...
			case "Axis":
				match self.level:
					...
					case 6:
						...
						self.day_available = 18
class Sp_Artillery(Unit):
	def __init__(self, level, game, territory=None, buildings=None, health=None, build=True):
		super().__init__(level, game, territory, buildings, health, build)
		self.name = "SP Artillery"
		self.description = "Self propelled (SP) Artillery is an offensive unit that is most effective against armored targets and buildings. It combines armor and speed with the ability to bombard enemies from a safe distance and is best used to travel alongside other motoized units."
		self.special = None
		self.armor_class = "light armor"
		if build:
			self.update_stats()
		...
		self.terrain_effects = {'plains': {'HP': self.health, 'armor': self.armor_class, 'speed': 1.25, 'strength': 1.20}, 'hills': {'HP': self.health, 'armor': self.armor_class, 'speed': -1.20, 'strength': 1.5}, 'mountains': {'HP': self.health, 'armor': self.armor_class, 'speed': -1.5, 'strength': None}, 'forest': {'HP': self.health, 'armor': self.armor_class, 'speed': -1.25, 'strength': None}, 'urban': {'HP': self.health, 'armor': self.armor_class, 'speed': None, 'strength': None}, 'sea': {'HP': 10, 'armor': 'ship', 'speed': None, 'strength': None}, 'enemy_territory': {'HP': None, 'armor': None, 'speed': -1.50, 'strength': None}}
	...
	def update_stats(self):
		match self.game.faction:
			case "Axis":
				match self.level:
					case 1:
						self.combat = {"unarmored": {"attack": 2.3, "defense": 0.6}, "light_armor": {"attack": 3.2, "defense": 0.8}, "heavy_armor": {"attack": 4.5, "defense": 1.1}, "airplane": {"attack": 1.8, "defense": 0.4}, "ship": {"attack": 3.2, "defense": 0.8}, "submarine": {"attack": 1.8, "defense": 0.4}, "buildings": {"attack": 3.2, "defense": 0.8}, "morale": 0.9}
						self.health = 20
						self.speed = 49
						self.view_range = 42
						self.attack_range = 50
						self.production_costs = {'gas': 1400, 'steel': 1500, 'cash': 1900, 'manpower': 1200}
						self.research_costs = {'gas': 3250, 'steel': 3600, 'cash': 8600}
						self.daily_costs = {'gas': 58, 'manpower': 49, 'steel': 63, 'cash': 77}
						self.minimum_production_time = 1.58
						self.research_time = 4.5
						self.day_available = 4
					case 2:
						self.combat = {"unarmored": {"attack": 3.0, "defense": 0.8}, "light_armor": {"attack": 4.1, "defense": 1.0}, "heavy_armor": {"attack": 5.9, "defense": 1.5}, "airplane": {"attack": 2.5, "defense": 0.6}, "ship": {"attack": 4.1, "defense": 1.0}, "submarine": {"attack": 2.5, "defense": 0.6}, "buildings": {"attack": 4.1, "defense": 1.0}, "morale": 1.3}
						self.health = 25
						self.speed = 55
						self.view_range = 42
						self.attack_range = 50
						self.production_costs = {'gas': 1600, 'steel': 1800, 'cash': 2100, 'manpower': 1200}
						self.research_costs = {'gas': 4200, 'steel': 4700, 'cash': 11500}
						self.daily_costs = {'gas': 67, 'manpower': 51, 'steel': 74, 'cash': 88}
						self.minimum_production_time = 1.93
						self.research_time = 5.75
						self.day_available = 8
					case 3:
						self.combat = {"unarmored": {"attack": 3.9, "defense": 1.0}, "light_armor": {"attack": 5.4, "defense": 1.3}, "heavy_armor": {"attack": 7.7, "defense": 1.9}, "airplane": {"attack": 3.4, "defense": 0.9}, "ship": {"attack": 5.4, "defense": 1.3}, "submarine": {"attack": 3.4, "defense": 0.9}, "buildings": {"attack": 5.4, "defense": 1.3}, "morale": 1.8}
						self.health = 30
						self.speed = 61
						self.view_range = 42
						self.attack_range = 50
						self.production_costs = {'gas': 1800, 'steel': 2000, 'cash': 2400, 'manpower': 1200}
						self.research_costs = {'gas': 5200, 'steel': 5750, 'cash': 14400}
						self.daily_costs = {'gas': 76, 'manpower': 51, 'steel': 83, 'cash': 100}
						self.minimum_production_time = 2.18
						self.research_time = 7.5
						self.day_available = 12
					case 4:
						self.combat = {"unarmored": {"attack": 5.0, "defense": 1.3}, "light_armor": {"attack": 7.2, "defense": 1.8}, "heavy_armor": {"attack": 9.9, "defense": 2.5}, "airplane": {"attack": 4.5, "defense": 1.1}, "ship": {"attack": 7.2, "defense": 1.8}, "submarine": {"attack": 4.5, "defense": 1.1}, "buildings": {"attack": 7.2, "defense": 1.8}, "morale": 2.4}
						self.health = 40
						self.speed = 67
						self.view_range = 42
						self.attack_range = 50
						self.production_costs = {'gas': 2000, 'steel': 2300, 'cash': 2700, 'manpower': 1300}
						self.research_costs = {'gas': 6150, 'steel': 6850, 'cash': 17350}
						self.daily_costs = {'gas': 83, 'manpower': 53, 'steel': 93, 'cash': 111}
						self.minimum_production_time = 2.5
						self.research_time = 9.5
						self.day_available = 16
					case 5:
						self.combat = {"unarmored": {"attack": 6.3, "defense": 1.6}, "light_armor": {"attack": 9.5, "defense": 2.4}, "heavy_armor": {"attack": 12.6, "defense": 3.1}, "airplane": {"attack": 5.9, "defense": 1.5}, "ship": {"attack": 9.5, "defense": 2.4}, "submarine": {"attack": 5.9, "defense": 1.5}, "buildings": {"attack": 9.9, "defense": 2.5}, "morale": 3.2}
						self.health = 55
						self.speed = 73
						self.view_range = 42
						self.attack_range = 50
						self.production_costs = {'gas': 2200, 'steel': 2500, 'cash': 3000, 'manpower': 1300}
						self.research_costs = {'gas': 6150, 'steel': 6850, 'cash': 17350}
						self.daily_costs = {'gas': 91, 'manpower': 55, 'steel': 102, 'cash': 123}
						self.minimum_production_time = 2.68
						self.research_time = 11.5
						self.day_available = 20
